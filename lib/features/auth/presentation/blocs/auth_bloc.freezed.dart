...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( _AppStarted value)?  appStarted,TResult Function( _UserChanged value)?  userChanged,TResult Function( _LogoutRequested value)?  logoutRequested,required TResult orElse(),}){
final _that = this;
switch (_that) {
case _AppStarted() when appStarted != null:
return appStarted(_that);case _UserChanged() when userChanged != null:
return userChanged(_that);case _LogoutRequested() when logoutRequested != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( _AppStarted value)  appStarted,required TResult Function( _UserChanged value)  userChanged,required TResult Function( _LogoutRequested value)  logoutRequested,}){
final _that = this;
switch (_that) {
case _AppStarted():
return appStarted(_that);case _UserChanged():
return userChanged(_that);case _LogoutRequested():
return logoutRequested(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( _AppStarted value)?  appStarted,TResult? Function( _UserChanged value)?  userChanged,TResult? Function( _LogoutRequested value)?  logoutRequested,}){
final _that = this;
switch (_that) {
case _AppStarted() when appStarted != null:
return appStarted(_that);case _UserChanged() when userChanged != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  appStarted,TResult Function( UserEntity? user)?  userChanged,TResult Function()?  logoutRequested,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AppStarted() when appStarted != null:
return appStarted();case _UserChanged() when userChanged != null:
return userChanged(_that.user);case _LogoutRequested() when logoutRequested != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  appStarted,required TResult Function( UserEntity? user)  userChanged,required TResult Function()  logoutRequested,}) {final _that = this;
switch (_that) {
case _AppStarted():
return appStarted();case _UserChanged():
return userChanged(_that.user);case _LogoutRequested():
return logoutRequested();case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  appStarted,TResult? Function( UserEntity? user)?  userChanged,TResult? Function()?  logoutRequested,}) {final _that = this;
switch (_that) {
case _AppStarted() when appStarted != null:
return appStarted();case _UserChanged() when userChanged != null:
return userChanged(_that.user);case _LogoutRequested() when logoutRequested != null:
